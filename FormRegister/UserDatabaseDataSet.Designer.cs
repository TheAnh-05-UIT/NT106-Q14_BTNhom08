...
namespace FormRegister {
    ...
    public partial class UserDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class SINHVIENDataTable : global::System.Data.TypedTableBase<SINHVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SINHVIENRow AddSINHVIENRow(string NAMESV, string EMAIL, string PHONE) {
            ...
            private void InitClass() {
                ...
                this.columnNAMESV.AllowDBNull = false;
                this.columnNAMESV.MaxLength = 50;
        ...
        public partial class SINHVIENRow : global::System.Data.DataRow {
            ...
            public string NAMESV {
                get {
                    return ((string)(this[this.tableSINHVIEN.NAMESVColumn]));
                }
                set {
                    this[this.tableSINHVIEN.NAMESVColumn] = value;
                }
            }
...
namespace FormRegister.UserDatabaseDataSetTableAdapters {
    ...
    public partial class SINHVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[SINHVIEN] WHERE (([Id] = @Original_Id) AND ([NAMESV] = @Origin" +
                "al_NAMESV) AND ((@IsNull_EMAIL = 1 AND [EMAIL] IS NULL) OR ([EMAIL] = @Original_" +
                "EMAIL)) AND ((@IsNull_PHONE = 1 AND [PHONE] IS NULL) OR ([PHONE] = @Original_PHO" +
                "NE)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[SINHVIEN] ([NAMESV], [EMAIL], [PHONE]) VALUES (@NAMESV, @EMAIL" +
                ", @PHONE);\r\nSELECT Id, NAMESV, EMAIL, PHONE FROM SINHVIEN WHERE (Id = SCOPE_IDEN" +
                "TITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[SINHVIEN] SET [NAMESV] = @NAMESV, [EMAIL] = @EMAIL, [PHONE] = @PHONE WHERE (([Id] = @Original_Id) AND ([NAMESV] = @Original_NAMESV) AND ((@IsNull_EMAIL = 1 AND [EMAIL] IS NULL) OR ([EMAIL] = @Original_EMAIL)) AND ((@IsNull_PHONE = 1 AND [PHONE] IS NULL) OR ([PHONE] = @Original_PHONE)));
SELECT Id, NAMESV, EMAIL, PHONE FROM SINHVIEN WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FormRegister.Properties.Settings.Default.UserDatabaseConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, NAMESV, EMAIL, PHONE FROM dbo.SINHVIEN";
        ...
        public virtual int Fill(UserDatabaseDataSet.SINHVIENDataTable dataTable) {
        ...
        public virtual UserDatabaseDataSet.SINHVIENDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDatabaseDataSet.SINHVIENDataTable dataTable = new UserDatabaseDataSet.SINHVIENDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDatabaseDataSet.SINHVIENDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_NAMESV, string Original_EMAIL, string Original_PHONE) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            if ((Original_NAMESV == null)) {
                throw new global::System.ArgumentNullException("Original_NAMESV");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_NAMESV));
            }
        ...
        public virtual int Insert(string NAMESV, string EMAIL, string PHONE) {
            if ((NAMESV == null)) {
                throw new global::System.ArgumentNullException("NAMESV");
            }
            else {
        ...
        public virtual int Update(string NAMESV, string EMAIL, string PHONE, int Original_Id, string Original_NAMESV, string Original_EMAIL, string Original_PHONE, int Id) {
            if ((NAMESV == null)) {
                throw new global::System.ArgumentNullException("NAMESV");
            }
            else {
            ...
            if ((Original_NAMESV == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_NAMESV));
            }
            if ((Original_EMAIL == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NAMESV, string EMAIL, string PHONE, int Original_Id, string Original_NAMESV, string Original_EMAIL, string Original_PHONE) {
            return this.Update(NAMESV, EMAIL, PHONE, Original_Id, Original_NAMESV, Original_EMAIL, Original_PHONE, Original_Id);
        }
    }
